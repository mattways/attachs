=== NOTE: Attachment method has been removed just use a regular string from version 0.0.5
...
You can also specify a default file/image to use:
  class Model < ActiveRecord::Base
    attr_accessible :prop
    attached_file :prop, :default => 'file.txt'
  end
